namespace SU.StudentServices.Data.Helpers
{
	public class CurrencyInfo
    {
        public enum Currencies { Syria = 0, UAE, SaudiArabia, Tunisia, Yemen, Gold, NoCurrency, Dollar, KWD };
        ...
        public CurrencyInfo(Currencies currency)
        {
            switch (currency)
            {
                ...
                case Currencies.Yemen:
                    ...
                    EnglishCurrencyPartName = "Fls";
                    EnglishPluralCurrencyPartName = "Flses";
                    Arabic1CurrencyName = "ريال يمني";
                    Arabic2CurrencyName = "ريالان يمنيان";
                    Arabic310CurrencyName = "ريالات يمنية";
                    Arabic1199CurrencyName = "ريالاً يمنيا";
                    Arabic1CurrencyPartName = "فلس";
                    Arabic2CurrencyPartName = "فلسان";
                    Arabic310CurrencyPartName = "فلوس";
                ...
                case Currencies.Dollar:
                    ...
                    EnglishPluralCurrencyName = "US Dollar";
                ...
                case Currencies.KWD:
                    ...
                    //Arabic310CurrencyName = "دينارات كويتية";
                    Arabic310CurrencyName = "دنناير كويتية";
